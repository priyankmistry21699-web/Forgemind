...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "traffic_split_pct", sa.Float(), nullable=False, server_default="50.0"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "burn_rate_usd_per_day", sa.Float(), nullable=False, server_default="0.0"
        ),
        sa.Column("days_remaining", sa.Integer(), nullable=False, server_default="0"),
        sa.Column(
            "will_exceed_budget", sa.Boolean(), nullable=False, server_default="0"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "include_approvals", sa.Boolean(), nullable=False, server_default="1"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "pattern_type", sa.String(20), nullable=False, server_default="regex"
        ),
