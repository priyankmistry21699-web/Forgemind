...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("lead", "operator", "reviewer", "viewer", name="project_role"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "channel",
            sa.Enum("slack", "email", "webhook", name="delivery_channel"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("active", "paused", "disabled", name="delivery_status"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "decision",
            sa.Enum("approve", "request_changes", "comment", name="review_decision"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "patch_id",
            UUID(as_uuid=True),
            sa.ForeignKey("patch_proposals.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column("title", sa.String(500), nullable=False),
        sa.Column("body", sa.Text, nullable=True),
