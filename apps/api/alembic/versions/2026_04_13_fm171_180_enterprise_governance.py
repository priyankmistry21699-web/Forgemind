...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), primary_key=True),
        sa.Column("policy_id", sa.Uuid(), sa.ForeignKey("governance_policies.id", ondelete="CASCADE"), nullable=False, index=True),
    ...
    op.create_index("ix_gpe_policy_created", "governance_policy_evaluations", ["policy_id", "created_at"])
    ...
    op.create_table(
        ...
        sa.Column("generated_by", sa.Uuid(), sa.ForeignKey("users.id", ondelete="SET NULL"), nullable=False),
        sa.Column("project_id", sa.Uuid(), sa.ForeignKey("projects.id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("created_by", sa.Uuid(), sa.ForeignKey("users.id", ondelete="SET NULL"), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
