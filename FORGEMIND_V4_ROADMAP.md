...
- [ ] Feature branches auto-created with correct naming *(deferred — requires live GitHub API integration)*
...
- [ ] Extension installs and authenticates against ForgeMind API *(DEFERRED — separate VS Code extension project)*
- [ ] Sidebar shows active runs, tasks, and approvals *(DEFERRED)*
- [ ] Status bar reflects current run state *(DEFERRED)*
- [ ] Quick actions execute correctly *(DEFERRED)*
- [ ] Extension tested manually *(DEFERRED)*
...
- [ ] Documentation covers setup, configuration, and troubleshooting *(docs deferred to post-Wave 16)*
